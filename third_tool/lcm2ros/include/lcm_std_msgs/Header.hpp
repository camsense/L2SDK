...
#ifndef __lcm_std_msgs_Header_hpp__
#define __lcm_std_msgs_Header_hpp__

#include <lcm/lcm_coretypes.h>

#include <string>
#include "lcm_std_msgs/Time.hpp"
...
uint64_t Header::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xdbb33f5b4c19b8eaLL +
         lcm_std_msgs::Time::_computeHash(&cp);
